...
description: "Configura la cadena de conexión SQL Server, ajusta la política de contraseñas y entiende los parámetros de inicio de la aplicación en appsettings.json."
---
