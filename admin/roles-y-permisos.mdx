...
description: "Sistema RBAC con roles Admin y Vendedor. Detalla permisos por controlador, cuentas semilla precargadas y las rutas de redirección para acceso denegado."
---
