...
<ParamField path="Telefono" type="string" default="null">
  Número de celular de contacto del proveedor. Campo **opcional**. Cuando se proporciona, debe cumplir el formato de celular peruano según la expresión regular:
