...
sidebarTitle: "Venta"
description: "Referencia del modelo Venta en Tienda MiCholo: campos, enumeraciones EstadoVenta y TipoComprobante, y el modelo VentaItem para el carrito temporal."
---
