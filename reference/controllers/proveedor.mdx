...
description: "Referencia del ProveedorController: listar, crear, editar y eliminar proveedores. Todo el controlador requiere rol Admin. Valida unicidad de RUC y protege relaciones."
---
